  ...
  return (
    <div className="main-content">
      ...
      {!showForm ? (
        ...
        <div>
          <Button
            variant="contained" // Change to "contained" for a more pronounced look
            color="primary" // You can change this to any color that fits your theme
            onClick={handleBackClick}
            startIcon={<ArrowBackIcon />} // Add an icon to the left of the text
            sx={{
              mb: 2,
              background: "linear-gradient(90deg, #7c0e0e, #8b0000)",
              color: "#ffffff",
